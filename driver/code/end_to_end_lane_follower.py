...
class EndToEndLaneFollower(object):
    ...
    def __init__(self,
                 car=None,
                 model_path='E:/Python/Do_An_Tot_Nghiep/models/lane_navigation/data/model_result/lane_navigation.h5'):
...
if __name__ == '__main__':
    ...
    test_video('E:/Python/Do_An_Tot_Nghiep/models/lane_navigation/data/video1')
